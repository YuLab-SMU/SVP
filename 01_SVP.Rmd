...
```{r, fig.width = 9, fig.height = 7, fig.align = 'center', fig.cap="(ref:runSGSA_free)", runSGSA_free}
...
```{r, fig.align = 'center', fig.width = 11, fig.height=11, fig.cap = '(ref:heatmap_celltype)', heatmap_celltype}
...
```{r, fig.width = 9, fig.height = 7, fig.align = 'center', fig.cap='(ref:runSGSA_ref)', runSGSA_ref}
...
```{r, fig.width = 9, fig.height = 3, fig.align = 'center', fig.cap="(ref:LISA_G_fig)", LISA_G_fig}
gsvaExp(pdac_a_spe, 'CellTypeFree') |> 
  plot_lisa_feature(
...
```{r, fig.width = 9, fig.height = 3, fig.align = 'center', fig.cap='(ref:LISA_I_fig)', LISA_I_fig}
gsvaExp(pdac_a_spe, "CellTypeFree") |>
  plot_lisa_feature(
...
```{r, fig.width = 7, fig.height = 5.5, fig.align = 'center', fig.cap="(ref:fig_gbv)", fig_gbv}
...
```{r, fig.width = 6, fig.height=5.6, fig.align = 'center', fig.cap = "(ref:runGLOBALBV_CellType_CancerSEA)", runGLOBALBV_CellType_CancerSEA}
